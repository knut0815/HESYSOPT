...
scenario_colors = colors = dict(zip(scenarios.keys(),
                                sns.color_palette("coolwarm_r", len(scenarios.keys()))))
...
pp.sorted_curves(OB, scenario_colors)
pp.sorted_curves(BP1, scenario_colors)
